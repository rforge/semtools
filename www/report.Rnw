...
\title{\vspace*{-0.4cm} Generalized Measurement Invariance Tests with Application to Factor Analysis}
\Plaintitle{Generalized Measurement Invariance Tests with Application to Factor Analysis}
