...
\frame{
  ...
  \begin{itemize}
    \item If we did not know the groups in advance, we could conduct a LRT wrt to all possible groups, taking the maximum.  The proposed tests are related to this idea.
  \end{itemize}
 % TODO Insert Fig 3
}
