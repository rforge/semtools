...
gefp_4_info_1 <- gefp(wdh0.1, fit = NULL, order.by = d$gpa[d$grouping=="exp:minority"], parm = 15:18, vcov = info.wdhfit, sandwich = FALSE)
gefp_1_info_1 <- gefp(wdh0.1, fit = NULL, order.by = d$gpa[d$grouping=="exp:minority"], parm = 18, vcov = info.wdhfit, sandwich = FALSE)
