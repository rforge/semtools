...
\seeme{I don't understand this sentence. cross-product of each individual for each parameter? Why this 
...
package psychotools CITE.  The data consist of responses to three adult 
