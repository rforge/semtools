...
$i$-th smallest value of the auxiliary variable.
...
Finally, if $V$ is only nominal/categorical, the cumulative sums of scores can be used to obtain a Lagrange multiplier statistic.
