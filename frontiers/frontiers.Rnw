...
Many of the papers in this special issue focus on the topic of approximate measurement invariance: we know that strict hypotheses of measurement invariance do not hold exactly across different groups, and this should be reflected in tests of measurement invariance.  BSEM
...
\readme{Isn't this five subsets of parameters, not seven?}
...
\readme{Make sure there is a space after each comma and period:}
