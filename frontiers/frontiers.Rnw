...
We focus on measurement invariance of the factor loadings associated with t
he GQ-6 scale, using a one-factor model.While the ``age group'' variable against 
...
if(file.exists("sim2.rda")) {
  ...
  sim2 <- simulation(sim=c("sim2"), nobs=c(480),parms=c("extra","extra+loading","extra+var","extra+error"))
