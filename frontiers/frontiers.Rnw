...
\readme{We need a better intro here.  The special topic is about measurement invariance, so most of this paragraph is obvious to everyone.  Maybe start with how so many other papers are about BSEM.}
...
\readme{I just added LMuo to the sctest command; the range statistic is different.}
