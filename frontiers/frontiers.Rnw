...
further comparison of these methods]{MerZei13}.
...
the GQ-6 scale, using a one-factor model.  This scale consists of five
items scored from 1--9.  While the ``age group'' variable against 
