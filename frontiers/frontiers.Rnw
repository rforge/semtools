...
\readme{Ting: The problem with the last statistic is having
  fplot=TRUE.  To get around this, you can add random noise or set
  fplot=FALSE (I've done the latter).}
