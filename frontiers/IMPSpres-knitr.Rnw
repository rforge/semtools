...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.33\textwidth}     
      \begin{block}{Unordered Score}
        \resizebox{3.3cm}{!}{ 
          $
            \begin{blockarray}{lccccc}
              \text{obs} &\theta_{1} & \theta_{2} & \ldots 
                     &\textcolor{red}{\theta_{k}} & \text{age} \\
               \begin{block}{l(cccc)c}
                 &4.12 & 3.48 & \ldots & -3.11 & 11.3\\
                 &1.32  & -4.32 & \ldots & -2.34 & 10.5\\
                 &3.37 & 8.32 & \ldots & 63.45 & 11.0\\ 
                 &-5.78 & 3.50 & \ldots & 7.67 & 18.9\\
                 &\vdots & \vdots & \vdots & \vdots & 17.1\\ 
                 &12.34 & 13.32 & \ldots & 6.89 & 18.6\\              
               \end{block}
            \end{blockarray} 
           $
          }
            ...
            \begin{blockarray}{lccccc}
              \text{obs}& \theta_{1} & \theta_{2} & \ldots 
               ...
               \begin{block}{l(cccc)c}
                 ...
                 x_{..} & \vdots & \vdots & \vdots & \vdots & 17.1\\ 
...
\label{fig:ordres}
<<sctest-ord-graphics,  out.width="250px", out.height ="180px", echo=FALSE, results='hide'>>=
