...
\frametitle{Measurement Invariance}
  \begin{itemize}
    ...
    \item Notable examination of measurement invariance:
      \begin{itemize}
         \item SAT for different ethnic groups (Atkinson, 2001, CITE)
         \item Intelligence tests for different cohorts
           (Jelte M. Wicherts, Conor V.Dolan, David J. Hessen CITE)     
      \end{itemize}
  \end{itemize}
\end{frame}
%--------------------------------------------------------------------------
...
\begin{frame}
  ...
  \begin{itemize}
    \item The score-based tests (CITE Edgar Merkle and Achim Zeileis, 2013) 
